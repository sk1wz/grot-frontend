      ...
      {isOpen ? (
        ...
        >
          <button
            ...
            className="flex h-11 w-full cursor-pointer items-center gap-2.5 border-b border-(--border) px-3 text-left text-[13px] font-medium text-(--foreground) transition-colors hover:bg-(--accent)"
          >
          ...
          <Link
            ...
            role="menuitem"
            onClick={() => setIsOpen(false)}
            className="flex h-11 items-center gap-2.5 border-b border-(--border) px-3 text-[13px] font-medium text-(--foreground) transition-colors hover:bg-(--accent)"
          >
          ...
          <button
            ...
            className="flex h-11 w-full cursor-pointer items-center gap-2.5 px-3 text-left text-[13px] font-medium text-(--foreground) transition-colors hover:bg-(--accent) disabled:cursor-not-allowed disabled:opacity-50"
          >
